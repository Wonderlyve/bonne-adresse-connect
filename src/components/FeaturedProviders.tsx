...
import { Star, MapPin, MessageCircle, ShoppingBag, CheckCircle } from "lucide-react";
      ...
      {featuredProviders.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {featuredProviders.map((provider) => (
            <div 
              key={provider.id} 
              className="group hover:shadow-lg transition-shadow cursor-pointer rounded-lg overflow-hidden bg-white border"
